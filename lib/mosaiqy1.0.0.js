...
(function($) {
    ...
    Mosaiqy = function($) {
        ...
        return {
            ...
            init    : function(cnt, options) {
                ...
                $.when(_img.mosaiqyImagesLoad(function(img) { img.animate({ opacity : '1' }, _s.fadeSpeed); }, _s.loadTimeout))
                /**
     ...
     * @lends _$.fn
     */
    _$.fn.mosaiqyImagesLoad = function(imgCallback, to) {
